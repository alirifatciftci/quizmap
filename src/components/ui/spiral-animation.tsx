...
class Star {
  ...
  render(p: number, controller: AnimationController) {
    ...
    const vx = (this.z - (controller as unknown as Record<string,number>)['cameraZ']) * screenX / (controller as unknown as Record<string,number>)['viewZoom']
    const vy = (this.z - (controller as unknown as Record<string,number>)['cameraZ']) * screenY / (controller as unknown as Record<string,number>)['viewZoom']
